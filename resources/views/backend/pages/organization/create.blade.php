...
@section('title', 'প্রতিষ্ঠান নিবন্ধন')
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <!-- Basic Bootstrap Table -->
        <div class="card">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-header">নতুন প্রতিষ্ঠান</h5>
                <a href="{{ route('organizations.index') }}" class="btn btn-primary me-7">সকল প্রতিষ্ঠানসমূহ</a>
            </div>
            <div class="card-body">
                <form action="{{ route('organizations.store') }}" method="post" class="needs-validation" novalidate>
                    @csrf
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="address" id="address" rows="5" class="form-control" placeholder="প্রতিষ্ঠানের ঠিকানা লিখুন" required></textarea>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" class="form-control" id="bin" name="bin_no" placeholder="বিন নম্বর লিখুন" required />
                    ...
                    <div class="mb-6">
                        ...
                        <select name="type" id="type" class="form-select" required>
                            ...
                            <option value="1">বাণিজ্যিক প্রতিষ্ঠান</option>
                            <option value="2">উৎপাদনকারী প্রতিষ্ঠান</option>
                        </select>
